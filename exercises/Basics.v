...
(** If you are using _Software Foundations_ in a course, your
    ...
    See the next section for more information about how to interpret
...
(** (We show Coq's responses in comments, but, if you have a
    ...
    Coq interpreter under your favorite IDE -- CoqIDE, Proof General,
    or VSCoq -- and try it for yourself.  Load this file, [Basics.v],
...
(** We do not accept late submissions in the Proofs are Programs course at RUB,
    but suppose that a course has a grading policy based on late days such
